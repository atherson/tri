            ...
            <tbody>
              {filtered.map(a => (
                <tr key={a.id} className="border-b hover:bg-slate-50 dark:hover:bg-navy-800/50">
                  ...
                  <td className="py-3 pr-4">
                    {a.event && <Link href={`/events/${a.event_id}`} className="text-accent-600 hover:underline">{a.event.name}</Link>}
                  </td>
                  <td className="py-3 pr-4">
                    {a.contract && <Link href={`/contracts/${a.contract_id}`} className="text-accent-600 hover:underline">{a.contract.contract_number}</Link>}
                  </td>
